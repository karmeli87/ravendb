...
namespace Raven.Server.Rachis
{
    public class CandidateAmbassador : IDisposable
    {
        ...
        public RemoteConnection PublishedConnection;
                    ...
                    try
                    {
                        ...
                        using (_engine.ContextPool.AllocateOperationContext(out TransactionOperationContext context))
                        {
                            ...
                            while (_candidate.Running)
                            {
                                ...
                                // clear the current published connection
                                Interlocked.Exchange(ref PublishedConnection, null)?.Dispose();
                                ...
                                // only here we can safely publish the connection
                                Interlocked.Exchange(ref PublishedConnection, _connection);
